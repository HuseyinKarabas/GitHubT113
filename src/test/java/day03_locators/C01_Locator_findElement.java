...
public class C01_Locator_findElement {
    public static void main(String[] args) throws InterruptedException {
        ...
        //WebDriver driver=new EdgeDriver(); yapılabilir çalşır
        WebDriver driver=new ChromeDriver();
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));
        //amazon anasayfasina giidn
        driver.get("https://www.amazon.com");
        //arama kutusuna Nutella yazdirin
        /*
        test otomasyonu yaparken bir webelementi kullanmak istersek 2 seye ihtiyacimiz var
        ...
        ornegin amazon sitesindeki arama kutusunun unique tarif edicisi olarak id="twotabsearchtextbox" kullanabiliriz
         */
        ...
        locator icin verdigimiz deger hataliysa veya locator stratejisinde hata yaptiysak aranan
        wen elementi implicitlyWait olarak tanimladigimiz maksimum süre boyunca arar bulamadigi icin
        "NoSuchElementException" firlatir ve kodlarin kalanini calistirmaz
         */
